...
# processing_tree(model_tables, outcome_label = "GO1")

# More trials for curvature
data <- simulate_model(model_tables, n_trials = 5000)
...
print(table(data$component, data$outcome, useNA = "ifany")/nrow(data))
...
# print(profile_res)
#
# plot_profile(profile_res,max_plots = 12)
