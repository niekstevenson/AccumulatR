...
`R2` feeds response `R2`. Parameters are grouped by default; the
`set_parameters()` call splits the two drift parameters and shares the
cross-distribution response-boundary and variability terms.
