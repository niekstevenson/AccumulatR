...
PROFILE_ENGINE_MODE=${ACCUMULATR_PROFILE_ENGINE_MODE:-ir_v2}
PROFILE_SHADOW_TOL=${ACCUMULATR_PROFILE_SHADOW_TOL:-1e-4}
...
echo "Engine mode: ${PROFILE_ENGINE_MODE} (shadow tol ${PROFILE_SHADOW_TOL})"
...
ACCUMULATR_PROFILE_ENGINE_MODE="$PROFILE_ENGINE_MODE" \
ACCUMULATR_PROFILE_SHADOW_TOL="$PROFILE_SHADOW_TOL" \
