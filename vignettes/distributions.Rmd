---
title: "Accumulator Distributions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Accumulator Distributions}
...
Outside of these all accumulators can have a non-decision time `t0` and a trigger
probability `q`. For the `exgauss` `t0` and `mu` are redundant (they both constitute
a shift in rt) and one must be fixed. 
