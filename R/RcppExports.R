...
semantic_make_likelihood_context_prep_cpp <- function(prepSEXP, diagnosticsSEXP) {
    .Call(`_AccumulatR_semantic_make_likelihood_context_prep_cpp`, prepSEXP, diagnosticsSEXP)
}
