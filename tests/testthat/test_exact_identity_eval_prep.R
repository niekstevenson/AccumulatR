...
testthat::test_that("exact identity likelihood matches pooled top-1 formula", {
  spec <- race_spec() |>
    add_accumulator("a", "lognormal") |>
...
testthat::test_that("exact identity likelihood handles contiguous trials across components", {
  spec <- race_spec() |>
    add_accumulator("a", "lognormal") |>
    add_accumulator("b", "lognormal") |>
    add_outcome("A", "a") |>
...
testthat::test_that("exact identity likelihood matches LBA top-1 formula", {
  spec <- race_spec() |>
...
testthat::test_that("exact identity likelihood matches RDM top-1 formula", {
  spec <- race_spec() |>
...
testthat::test_that("exact identity likelihood truncates exgauss at the elapsed-time lower bound", {
  spec <- race_spec() |>
...
testthat::test_that("identity likelihood supports shared-trigger no-response trials", {
  ...
  testthat::expect_equal(out, log(0.10), tolerance = 1e-4)
})
